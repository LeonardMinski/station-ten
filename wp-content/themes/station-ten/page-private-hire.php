<?php
$booking_type = stationten_booking_type('private-hire');
...
<div class="station-page">
    ...
    <section class="station-booking-detail">
        <div class="station-info-card">
            <h2>Suitable for</h2>
            <p>Birthdays, dinners, receptions, and intimate private celebrations with flexible setup.</p>
            <ul class="station-feature-list">
                <li>Private room or venue request</li>
                <li>Date and preferred start time</li>
                <li>Catering and atmosphere notes</li>
            </ul>
        </div>
        ...
        <form class="station-booking-form" method="post">
            ...
            <div class="station-form-grid">
                ...
                <label>
                    <span>Guests</span>
                    <input type="number" name="guest_count" min="1" step="1" placeholder="40">
                </label>
                <label>
                    <span>Phone</span>
            ...
            <label class="station-form-full">
                ...
                <textarea name="requirements" rows="6" placeholder="Food and drink package, decor, music, or accessibility needs"></textarea>
            </label>
